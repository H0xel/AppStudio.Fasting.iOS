...
struct MealItem: Codable, Hashable {
    ...
    /*
     для кейса с весом в сервинге, servingMultiplier - это коэффициент веса,
     т.е. чтобы узнать вес в граммах  нужно 100 * servingMultiplier

     для кейса без веса в сервинге, servingMultiplier - это коэффициент количества порций,
     определяет сколько порций в еде!
     */
    var servingMultiplier: Double = 1.0
    /*
     сервинг может быть 2 типов: с весом и без веса

     - с весом )     каждый сервинг в массиве servings должен иметь вес
     , конвертация сервингов происходит через вес в граммах
