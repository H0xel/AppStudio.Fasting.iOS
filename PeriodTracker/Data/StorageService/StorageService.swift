...
private let isPushNotificationsPermissionGrantedKey = "AppStudioApp.isPushNotificationsPermissionGrantedKey"
...
extension StorageService {
    ...
    var intercomUserId: String? {
        get { get(key: intercomUserIdKey) }
        set { set(key: intercomUserIdKey, value: newValue) }
    }

    var intercomUserHash: String? {
        get { get(key: intercomUserHashKey) }
        set { set(key: intercomUserHashKey, value: newValue) }
    }

    var isPushNotificationsPermissionGranted: Bool? {
        get { get(key: isPushNotificationsPermissionGrantedKey) }
        set { set(key: isPushNotificationsPermissionGrantedKey, value: newValue) }
    }
}
